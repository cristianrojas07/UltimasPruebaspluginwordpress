...
class MemberGeniusCartWarrior extends MemberGeniusCart {
	function instructions() {
		...
		<p><input type="text" name="warriorplus_token" value="<?php echo htmlentities($miembropress->model->setting("warriorplus_token")); ?>" size="35" /><input type="submit" class="button" value="Save WarriorPlus Security Key" /></p>
