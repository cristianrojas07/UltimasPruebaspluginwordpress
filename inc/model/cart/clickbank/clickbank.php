...
class MiembroPressCartClickbank extends MiembroPressCart {
	function instructions() {
      ...
      <p><input type="submit" class="button-primary menus_buttons button-activate " value="Save Account Settings" /></p>
    ...
    if ($item) {
      ...
      <p><input type="submit" class="button-primary menus_buttons button-activate " value="Save Clickbank ID's" /></p>
