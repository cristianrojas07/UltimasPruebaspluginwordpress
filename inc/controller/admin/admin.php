...
class MiembroPressAdmin {
	...
	public function menu_levels_list() {
		...
		<form method="post">
			...
			<p><input class="button-primary" type="submit" value="Save All Changes" onclick="return miembropress_confirmLevels();"/> 
			<input class="button" type="submit" value="Delete Selected Levels" onclick="return miembropress_confirmLevels();"/></p>
		</form>
	    <script type="text/javascript">
			jQuery(function() {
